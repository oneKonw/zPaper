...
class MapcorrectList extends Component {
  constructor(props) {
    ...
    this.loadmapcorrect = this.loadmapcorrect.bind(this);
  }
      ...
      >
        ...
        >
          <p style={{ marginBottom: '0' }}>
            <span
              style={{ display: 'inline-block', width: '80px', color: 'black', fontWeight: 'bold' }}
            >
              标题
            </span>
            <span
            ...
            <span
              style={{ display: 'inline-block', width: '200px', color: 'black', fontWeight: 'bold' }}
            >
              内容
            </span>
          </p>
          ...
          <p>
            ...
            >
              <Icon type="plus-circle" />绘制纠错点
            </Button>
            <Button
              onClick={this.loadmapcorrect}
              style={{
                marginLeft: '24px',
                width: '80px',
                borderRadius: 0,
